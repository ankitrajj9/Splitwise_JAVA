		...
		if(myExpenses != null && !myExpenses.isEmpty()) {
    		for(Expense expense:myExpenses){
    			...
    			if(expense.getUser().getId().equals(userId)) {
    				userExpenseObj.addProperty("expenseDtl", "You spent : "+expense.getAmount() +" INR for "+expense.getDescription()+" With ("+spentWith+") On "+expense.getCreatedOn().toGMTString() );
    				...
    				userExpenseObj.addProperty("expenseDtl", expense.getUser().getName()+"("+expense.getUser().getEmail()+")" +" spent : "+expense.getAmount() +" INR for "+expense.getDescription()+" With ("+spentWith+") On "+expense.getCreatedOn().toGMTString());
